...
**The 5-minute interval, on average across all the days in the datasets, contains the 
  maximum number of steps, is `r intervalMaxNumberSteps`**


## In summary, the average daily activity pattern is the following:
##   * the 5-minute interval, on average daily activity pattern, contains the maximun numbers of steps, is `r intervalMaxNumberSteps`
...
**The mean and the median total number of steps taken per day is `r meanNewStepsDaily` and`r medianNewStepsDaily`. The impact of imputing missing data on the estimates of the total
...
### Yes, there are differences in activity patterns between weekdays and weekends. The activities in the weekdays are more intensive than in weekend.
